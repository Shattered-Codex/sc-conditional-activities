...
export class DocumentationMenu extends ApplicationV2 {
  static DEFAULT_OPTIONS = foundry.utils.mergeObject(super.DEFAULT_OPTIONS, {
    ...
    window: {
      title: Constants.localize("SCConditionalActivities.Settings.DocumentationMenu.Name", "Documentation"),
      resizable: false,
  ...
  static bindSettingsButton(html) {
    ...
    for (const candidate of candidates) {
      candidate.classList.add("sc-ca-docs-setting-row");
      ...
      button.classList.add("sc-ca-docs-button");
      if (button.dataset.scCaDocsBound === "true") {
        continue;
      }
      button.dataset.scCaDocsBound = "true";
